...
class DataDepo {
  ...
  Map<String, List<Widget>> matesAppFirstMessages = {
    "Özge": [
      ...
      const DayPassed(),
      const IncomingMessage(
          message: "Amirim yardımınızı gerektiren büyük bir cinayet olayı oldu. Büro olarak işin içinde çıkamadık."),
    ],
    "Orhun": [
      const DayPassed(day: 5),
    ...
    "Behram": [
      //10 nisan neşe doluyor insan
      const IncomingMessage(
          message: "Tüm polis teşkilatımızın polis haftası kutlu olsun."),
    ],
  };

  List<Widget> galleryImages = [
    const PhotoWidget(
        adress: 'assets/apps/photosApp/images/1500x500.jpeg'),
    ...
    const PhotoWidget(
        adress: 'assets/apps/photosApp/images/myCat.jpeg'),
    const PhotoWidget(
        adress: 'assets/apps/photosApp/images/benumit.jpeg'),
